...
dotnet publish src\RavensPort.App\RavensPort.App.csproj -c Release -f net10.0-windows10.0.19041.0 -r win-x64 -o "%~dp0publish" -p:PublishSingleFile=true -p:IncludeNativeLibrariesForSelfExtract=true --self-contained false
if errorlevel 1 (
